...
user in an INI file next to ArthaPortable.exe called ArthaPortable.ini.
...
copy AppNamePortable.ini from this directory to ArthaPortable.ini next to
ArthaPortable.exe. The options in the INI file are as follows:
